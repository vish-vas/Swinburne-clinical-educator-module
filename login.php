<?php
	...
	else if($_POST)
	{
		if(isset($_POST['email']) && $_POST['email']!='' && isset($_POST['password']) && $_POST['password']!='')
		{
			...
			$sql = "EXEC usp_ValidateLoginDetails @emailId = ?, @strPassword = ?";
               ...
               if(sqlsrv_has_rows($selectResult))
                {
                    ...
                    $_SESSION['userId'] = $tableRow['EDUCATOR_ID'];
					$_SESSION['user'] = $tableRow['FIRST_NAME'];
					$_SESSION['email'] = $tableRow['EMAIL'];
					$_SESSION['admin'] = 0;
					header("Location: training.php");
                }
                else
                ...
                <div class="login-page">
                    ...
                    <div class="form">
                        ...
                        <form class="login-form">
                            ...
                            <p class="message"><a href="userRegistration.php">Register</a></p>
                        </form>
                        <br/>
